...
export default class Allotment extends Component {
	constructor(props) {
		...
		this.state = {
			guides: [],
			students: [],
			alloting:[{guide:'Dr.kaja',students_alloted:[{roll_no:'14PT06', id:'1'},{roll_no:'14PT07', id:'2'}]},
					  {guide:'N Geetha',students_alloted:[{roll_no:'14PT08', id:'3'},{roll_no:'14PT09', id:'4'}]},	
					 ],
			guides_selected: [],
			students_alloted: [],
		}
		...
		return (
			<DragDropContext onDragEnd={this.onDragEnd}>
				...
				<Row>
					...
					<Col  style={colStyle}>
						<Card>
                			<CardHeader><h2>Guide</h2></CardHeader>
					...
					<Col  style={colStyle}>
						<Card>
            				<CardHeader><h2>Allotment</h2></CardHeader>
							<Droppable droppableId={'Map'}>
                    				{provided => (
                        				...
                        				>
											<CardBody>
												{this.state.alloting.map((map, index) => <Map key={map.guide} map={map} index={index} />)}
                            					{provided.placeholder}
											</CardBody>
                        				</div>
                    				)}
					...
					<Col  style={studStyle}>
						<Card>
                			<CardHeader><h2>Students</h2></CardHeader>
